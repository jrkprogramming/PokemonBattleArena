class trainers {
  constructor(
    ...
    bg,
    battle,
    calculateUserTypeMultiplier,
    calculateComputerTypeMultiplier,
    userDealsDamage,
    computerDealsDamage
  ) {
    this.name = name
...
alert(
  'Welcome to Pokemon Battle Arena by JRK! Please let the game load as you click through the menus and select Pokemon. This is an old project and has not been updated. When you select a Pokemon and only 1 move field pops up at the botton of the page, please refresh and try again! Ensure you have 4 move fields pop up when selecting a Pokemon. :)'
)
